...
(custom-set-variables
 ...
 '(dired-dwim-target t)
 '(dired-filter-group-saved-groups (quote (("default" ("PDF" (extension . "pdf")) ("LaTeX" (extension "tex" "bib")) ("Org" (extension . "org")) ("Archives" (extension "zip" "rar"))))))
 '(dired-filter-mark-prefix "\\")
 '(dired-filter-prefix "/")
 '(dired-filter-saved-filter-groups (quote (("default" ("PDF" (extension . "pdf")) ("LaTeX" (extension "tex" "bib")) ("Archives" (extension "zip" "rar"))))))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#2e3436" :foreground "#eeeeec" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "unknown" :family "Inconsolata"))))
 ...
 '(indent-guide-face ((t (:inherit paren-face))) t)
 ...
 '(variable-pitch ((t (:weight normal :height 144 :family "Source Sans Pro"))))
