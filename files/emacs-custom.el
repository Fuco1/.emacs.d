...
(custom-set-variables
 ...
 '(dired-dwim-target t)
 '(dired-filter-group-saved-groups (quote (("default" ("PDF" (extension . "pdf")) ("LaTeX" (extension "tex" "bib")) ("Org" (extension . "org")) ("Archives" (extension "zip" "rar" "gz" "bz2" "tar"))))))
...
#+END" "<pre>?</pre>"))))
 ...
 '(sp-sexp-suffix (quote ((json-mode regexp ""))))
