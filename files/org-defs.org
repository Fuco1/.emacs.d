...
* DONE Multiline fontification with org-emphasis-alist
...
* Logging
** DONE Use the input method from original org buffer in log note buffer
...
* DONE Make agenda clockreport respect =org-extend-today-until=
