...
(let ((fixed-sys (if (eq system-type 'windows-nt) "Consolas" "Inconsolata"))
  ...
  (my-tango-theme-set-faces
   ...
   (markup-italic (:slant italic :foreground butter-3))
